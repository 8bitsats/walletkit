...
import { ReactComponent as LogoDark } from "../../../common/svgs/LogoDark.svg";
    ...
    <div tw="relative flex items-center justify-between py-4">
      <div tw="z-50 flex items-center">
        <div tw="flex items-center">
          ...
          >
            <LogoDark tw="text-brand-800 hover:text-brand h-full w-full" />
          </NavLink>
          <NavLink to="/" tw="md:hidden h-10 hover:-rotate-3 transition-all">
            <Badge tw="text-brand-800 hover:text-brand h-full w-full" />
          </NavLink>
        </div>
      </div>
