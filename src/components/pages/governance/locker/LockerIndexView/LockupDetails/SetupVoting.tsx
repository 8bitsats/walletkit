  ...
  return (
    <Card title="Setup Voting" className={className}>
      <div tw="px-7 py-4 text-sm grid gap-4">
        <p>
          Participating in {daoName} Governance requires that an account have a
          balance of vote-escrowed {govToken?.symbol} ({veToken?.symbol}).
        ...
        <p>
          ...
          time is {maxStakeFmt}. One {govToken?.symbol} locked for {maxStakeFmt}{" "}
